...
import {
  ...
  id = "/subscriptions/${data.azurerm_client_config.current.subscription_id}/resourceGroups/${var.product}-${var.env}/providers/Microsoft.KeyVault/vaults/${var.product}-${var.env}/${data.azurerm_client_config.current.object_id}"
}
