...
import {
  ...
  id = "/subscriptions/${azurerm_client_config.current.subscription_id}/resourceGroups/${var.product}-${var.env}/providers/Microsoft.KeyVault/vaults/${var.product}-${var.env}/${azurerm_client_config.current.object_id}"
}
